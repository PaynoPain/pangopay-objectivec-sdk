...
withSuccessCallback:(PnPSuccessHandler)successHandler
   andErrorCallback:(PnPGenericErrorHandler)errorHandler{
    ...
    [NXOAuth2Request performMethod:@"POST"
                   ...
                   usingParameters:@{@"prefix":prefix,@"phone":phone,@"url_confirm":[confirmUrl absoluteString]}
                       withAccount:self.userAccount
                           timeout:PNP_REQUEST_TIMEOUT
               sendProgressHandler:nil
                   responseHandler:^(NSURLResponse *response, NSData *responseData, NSError *error){
...
-(void) editUserSetName:(NSString *) name
    ...
    [self changePhone:prefix phone:phone confirmUrl:url withSuccessCallback:^{
    ...
    [NXOAuth2Request performMethod:@"POST"
                   ...
                   usingParameters:@{@"name":name,@"surname":surname,@"email":email,@"pin":pin}
                       withAccount:self.userAccount
                           timeout:PNP_REQUEST_TIMEOUT
               sendProgressHandler:nil
                   responseHandler:^(NSURLResponse *response, NSData *responseData, NSError *error){
